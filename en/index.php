...
<body>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
             Home-Engine's primary objective is to develop highly efficient and environmentally friendly engine solutions for home use. They aim to reduce energy consumption, minimize emissions, and enhance the overall performance of home hardware engines. By integrating advanced technologies and employing innovative design approaches, Home-Engine is at the forefront of creating sustainable and energy-efficient solutions for residential power generation.
            </p>
            <a href="about.php">
              Read More
            </a>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
             Whether it's scheduling routine maintenance checks or addressing unexpected repairs, 
             on-site home maintenance and repair services provide homeowners with the necessary 
             support to keep their homes in excellent condition. By entrusting these tasks to professionals, 
             you can enjoy a safe, comfortable, and well-maintained living environment.
            </p>
            <a href="">
              Read More
            </a>
  ...
  <section class="service_section layout_padding">
    <div class="container ">
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <p>
                Home hardware maintenance plays a crucial role in ensuring the functionality, safety, and longevity of your household items and systems.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
               Proper upgrade of your home's electrical hardware involves a combination of routine inspections, preventive measures.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                In plumbing repair, homeowners can address problems such as clogged drains, leaky pipes, or malfunctioning toilets.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="btn-box">
        <a href="service.php?detail=9&type=service">
          View More
        </a>
      </div>
    </div>
